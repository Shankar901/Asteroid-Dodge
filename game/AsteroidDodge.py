...
def intro_screen():
	...
	while intro:
		...
		text_Surface, text_rect = text_("Asteroid Dodge", Text, (200, 200, 200))
		text_rect.center = (DISPLAY_WIDTH * 0.5, DISPLAY_HEIGHT * 0.35)
		surface.blit(text_Surface, text_rect)

		Text2 = pygame.font.SysFont(None, 40)
		with open('LocalData/score.txt', 'r') as f:
			content = f.read()
			content = content[content.find(' ') + 1:]
		text_Surface2, text_rect2 = text_(f"HighScore: {content}", Text2, (200, 200, 250))
		text_rect2.center = (DISPLAY_WIDTH * 0.15, DISPLAY_HEIGHT * 0.05)
		...
		button(600, 170, 530, 40, select_ship, (255, 210, 0), (250, 240, 0), "Change Ship")
